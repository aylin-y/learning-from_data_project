...
new_singers = {
    "Rock": ["Guns N' Roses", "Radiohead", "The Rolling Stones", "Deep Purple"],
    "Hip-Hop": ["Nas", "Dr. Dre", "J. Cole", "Travis Scott", "Wu-Tang Clan", "Public Enemy"],
    "Pop": ["Beyoncé", "Katy Perry", "Lady Gaga", "Adele", "Bruno Mars"],
    "Metal": ["Judas Priest", "Motörhead", "Anthrax", "Slipknot", "Sepultura"]
}
